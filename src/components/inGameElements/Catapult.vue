<template>
    <svg :x="position.x - 40" :y="position.y - 75" v-tooltip="'Chance to win is ' + catapult.chance_to_win + '%'">
        ...
        <!-- ARROW -->
        <svg :height="25" :width="25" x="50" y="25" viewBox="0 0 32 46" fill="none"
        ...
        <g class="the-catapult" :class="{mirrored: mirrored}">
            <svg width="75"
                 height="120"
                 viewBox="0 0 197 186"
                 fill="none"
                ...
                <path d="M135.111 42.9442L132.889 43.8331L140.444 46.9442L143.556 45.1664L135.111 42.9442Z"
                      fill="#90471F"
                      stroke="black"/>
...
<script>
    ...
    export default {
        ...
        computed: {
            mirrored() {
                return this.catapult.userCastleX > this.catapult.opponentCastleX;
            },
            angle() {
                return Math.floor(Math.atan2(this.catapult.userCastleY - this.catapult.opponentCastleY, this.catapult.userCastleX - this.catapult.opponentCastleX) * 180 / Math.PI) - 82;
            }
        },
        data() {
            return {
