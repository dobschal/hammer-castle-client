<template>
    <svg>
		...
		"/>
            ...
            <g v-tooltip="'This number describes the amount roads attached to the castle by the castles owner.'">
            ...
            <!-- Banner below -->
            <svg class="banner" :x="36" :y="150" width="175" height="60" viewBox="0 0 232 80" fill="none"
                 xmlns="http://www.w3.org/2000/svg">
          ...
          <text v-if="countDown && castle && castle.isInConquer" x="125" y="65" class="count-down" fill="black" text-anchor="middle">{{ countDown }}</text>
